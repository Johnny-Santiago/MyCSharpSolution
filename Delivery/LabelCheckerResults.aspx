<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.master" AutoEventWireup="true" CodeBehind="LabelCheckerResults.aspx.cs" Inherits="Delivery.LabelCheckerResults" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $("#BodyContentPlaceholder_ReportViewer1_ctl00_ctl07_txtValue").addClass("text grid_4");
            ...
            //            $("#ParametersGridBodyContentPlaceholder_ReportViewer1_ctl00 > tbody > tr > td:nth-child(2) > div > span > label").text("Blank");
        });
    </script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContentPlaceholder" runat="server">
    ...
    <h1 class="title-regular">Label Checker Results</h1>
