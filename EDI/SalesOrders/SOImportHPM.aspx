<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.master" AutoEventWireup="true" CodeBehind="SOImportHPM.aspx.cs" Inherits="EDI.SalesOrders.SOImportHPM" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContentPlaceholder" runat="server">
    ...
    <h1 class="title-regular">HPM - Import Sales Orders Per Kanban</h1>
    ...
    <div class="grid-viewer grid_19 clearfix">
        <asp:GridView ID="gvSheet" runat="server"  EnableViewState="true"
                ...
                DataKeyNames="ID,OrderDate,DeliveryDate,OrderedBy,OrderedByX,DeliverTo,DeliverToX,YourRef,YourRefX,DeliveryOrderNo,CustomerPartNo,IchikohPartNo,Quantity,SalesPrice"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="OrderDate" HeaderText="Delivery Schedule Ship Date" ReadOnly="True" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false" DataFormatString="{0:dd/MM/yyyy}" />
                <asp:BoundField DataField="DeliveryDate" HeaderText="Del. Date" Visible="false"  ReadOnly="True" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false" DataFormatString="{0:dd/MM/yyyy}" />
                ...
                <asp:BoundField DataField="YourRef" HeaderText="Slip No" ReadOnly="True" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="DeliveryOrderNo" HeaderText="Order No" Visible="false" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="ManifestNo" HeaderText="KD Lot Number" Visible="false" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                ...
                <asp:BoundField DataField="CustomerPartNo" HeaderText="Part Number" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                ...
                <asp:BoundField DataField="CustomerPartName" HeaderText="Part Description" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="Quantity" HeaderText="Delivery Schedule Quantity" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
