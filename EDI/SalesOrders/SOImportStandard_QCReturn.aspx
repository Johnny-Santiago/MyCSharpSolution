<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.master" AutoEventWireup="true" CodeBehind="SOImportStandard_QCReturn.aspx.cs" Inherits="EDI.SalesOrders.SOImportStandard_QCReturn" Culture = "en-GB" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContentPlaceholder" runat="server">
    ...
    <h1 class="title-regular">Standard QC Return - Import Sales Orders Per Kanban</h1>
    ...
    <div class="grid-viewer grid_19 clearfix">
        <asp:GridView ID="gvSheet" runat="server"  EnableViewState="true"
                ...
                DataKeyNames="ID,OrderDate,DeliveryDate,OrderedBy,OrderedByX,DeliverTo,DeliverToX,YourRef,YourRefX,CustomerPartNo,IchikohPartNo,Quantity"
