<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.master" AutoEventWireup="true" CodeBehind="SOImportADM.aspx.cs" Inherits="EDI.SalesOrders.SOImportADM" Culture="en-GB"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContentPlaceholder" runat="server">
    ...
    <h1 class="title-regular">ADM OEM - Import Sales Orders Per Kanban</h1>
    ...
    <div class="grid-viewer grid_19 clearfix">
        <asp:GridView ID="gvSheet" runat="server"  EnableViewState="true"
                ...
                DataKeyNames="ID,OrderDate,DeliveryDate,ShopCode,OrderedBy,OrderedByX,DeliverTo,DeliverToX,YourRef,YourRefX,DeliveryOrderNo,CustomerPartNo,IchikohPartNo,Quantity,SalesPrice"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DeliveryDate" HeaderText="Del. Date" ReadOnly="True" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false" DataFormatString="{0:dd/MM/yyyy}" />
                <asp:BoundField DataField="ShopCode" HeaderText="Shop Code" ReadOnly="True" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false" />
                ...
                <asp:BoundField DataField="YourRef" HeaderText="Job No" ReadOnly="True" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false" />
                ...
                <asp:BoundField DataField="ManifestNo" HeaderText="Manifest No" Visible="false" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                ...
                <asp:BoundField DataField="CustomerPartNo" HeaderText="Part No" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                ...
                <asp:BoundField DataField="CustomerPartName" HeaderText="Part Name" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="Quantity" HeaderText="Order(Pcs)" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
