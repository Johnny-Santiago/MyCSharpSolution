<%@ Page Title="" Language="C#" MasterPageFile="~/App_Resources/default.master" AutoEventWireup="true" CodeBehind="ForecastImport.aspx.cs" Inherits="EDI.Forecast.ForecastImport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContentPlaceholder" runat="server">
    ...
    <h1 class="title-regular">Import Forecast Orders</h1>

    <div class="notice">
        <asp:Label ID="lblStep1" runat="server" Text="Choose the customer forecast template or Excel file containing customer forecast orders. The file type should be in <em>xlsx</em>." />
    </div>
    ...
    <div class="grid-viewer grid_19 clearfix">
        <asp:GridView ID="gvSheet" runat="server"  EnableViewState="true"
            ...
            <%--<Columns>  DataKeyNames="ID,OrderDate,DeliveryDate,OrderedBy,OrderedByX,DeliverTo,DeliverToX,YourRef,YourRefX,CustomerPartNo,IchikohPartNo,Quantity"
                ...
                <asp:BoundField DataField="Description" HeaderText="Description" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="DeliveryOrderNo" HeaderText="Delivery order no." ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="ManifestNo" HeaderText="Manifest no." ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="RIT" HeaderText="RIT" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="CustomerPartNo" HeaderText="Customer part no." ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="IchikohPartNo" HeaderText="Ichikoh part no." ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="Quantity" HeaderText="Quantity" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="SalesPrice" HeaderText="Sales Price" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="InvoiceGroup" HeaderText="Invoice group" ReadOnly="True" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false" />
            </Columns>--%>
        </asp:GridView>
    </div>
</asp:Content>
